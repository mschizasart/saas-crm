    ...
    <div className="max-w-4xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage tax rates applied to invoices, estimates, and expenses</p>
        </div>
      ...
      {(showNew || editId) && (
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mb-6">
          <h2 className="text-sm font-semibold text-gray-700 mb-4">{editId ? 'Edit Tax' : 'New Tax'}</h2>
