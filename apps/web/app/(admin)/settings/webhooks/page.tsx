    ...
    <div>
      ...
      {!showForm && (
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 mb-6">
          <h2 className="text-sm font-semibold text-gray-700 mb-2">Quick Setup</h2>
          <p className="text-xs text-gray-500 mb-3">
            Connect your favorite messaging platform to receive CRM notifications in real time.
          </p>
