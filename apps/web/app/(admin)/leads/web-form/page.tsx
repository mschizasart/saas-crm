...
${inputLines.join('\n')}
  ...
  return (
    <div className="max-w-5xl">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Web-to-Lead Form</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <h2 className="text-sm font-semibold text-gray-700 mb-4">Field Configuration</h2>
              ...
              {fields.map(f => (
                <label key={f.key} className="flex items-center gap-3 text-sm">
                  ...
                  <span className={f.enabled ? 'text-gray-900' : 'text-gray-400'}>
                    ...
                    {f.alwaysOn && <span className="text-gray-400 ml-1 text-xs">(always on)</span>}
                  </span>
                </label>
              ))}
            </div>
        ...
        <div>
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <h2 className="text-sm font-semibold text-gray-700 mb-4">Form Preview</h2>
