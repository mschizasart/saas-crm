...
export default function EditLeadPage() {
  ...
  if (loading) return <div className="animate-pulse h-80 bg-gray-100 dark:bg-gray-800 rounded-xl max-w-3xl" />;
  ...
  return (
    <FormPageLayout
      ...
      footer={
        <>
          <Link href={`/leads/${id}`} className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">Cancel</Link>
