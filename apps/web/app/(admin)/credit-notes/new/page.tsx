...
export default function NewCreditNotePage() {
  ...
  return (
    <div className="max-w-6xl">
      <div className="mb-4">
        <Link href="/credit-notes" className="text-sm text-gray-500 hover:text-primary">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-4">
            ...
            <Field label="Invoice (optional)">
              ...
              {!clientId && (
                <p className="text-[10px] text-gray-400 mt-1">Select a customer first</p>
              )}
            </Field>
        ...
        <div className="flex justify-end gap-3 pt-2">
          <Link href="/credit-notes" className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 border border-gray-200 rounded-lg hover:bg-gray-50">
            Cancel
          </Link>
