...
export default function PortalNewTicketPage() {
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-4"><Link href="/portal/tickets" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary">← Back</Link></div>
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Submit a Ticket</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm p-6 space-y-4">
        ...
        <div>
          <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Subject <span className="text-red-500">*</span></label>
        ...
        <div className="flex justify-end gap-2 pt-4 border-t border-gray-100 dark:border-gray-800">
          <Link href="/portal/tickets" className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">Cancel</Link>
